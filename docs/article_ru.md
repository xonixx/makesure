...
- Реализация
    ...
    - или ручной парсинг
        - Сложнее в реализации, но больший контроль в валидации неинициализированных переменный, можем запретить функции shell, например `@define A="$(curl https://google.com)"`
